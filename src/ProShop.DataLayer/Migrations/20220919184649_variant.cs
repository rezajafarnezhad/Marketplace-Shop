    ...
    public partial class variant : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryVarieant", x => new { x.VariantId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_CategoryVarieant_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryVarieant_Variant_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryVarieant_CategoryId",
                table: "CategoryVarieant",
                column: "CategoryId");
        }
